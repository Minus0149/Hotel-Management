	...
	return (
		<div className="rounded-xl w-72 mb-10 mx-auto md:mx-0 overflow-hidden text-black">
			<div className="h-60 overflow-hidden">
				<Image
					src={urlFor(coverImage.image).url()}
					alt={name}
					width={250}
					height={250}
			...
			<div className="p-4 bg-white">
				...
				<Link
					...
					className={`${
						isBooked
							? "bg-slate-700 hover:animate-wiggle hover:bg-red-500"
							: "bg-primary hover:-translate-y-2"
					} inline-block text-center w-full py-4 rounded-xl text-white text-xl font-bold hover:shadow-lg transition-all duration-500`}
				>
