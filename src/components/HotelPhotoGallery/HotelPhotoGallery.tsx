...
const HotelPhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
	...
	return (
		<div className="container mx-auto">
			<div className="grid lg:grid-cols-2 relative gap-5 px-3">
				<div className="h-[540px] relative rounded-2xl overflow-hidden">
					<div className="hidden md:flex justify-center items-center w-full h-full">
						<Image
							src={urlFor(photos[0].image).url()}
					...
					<div className="lg:hidden flex justify-center items-center w-full h-full">
						<Image
							src={urlFor(photos[currenPhotoIndex].image).url()}
							alt={`Room Photo ${currenPhotoIndex + 1}`}
							className="img"
							width={500}
							height={500}
				...
				<div className="hidden lg:grid grid-cols-2 h-full gap-5">
					...
					{remainingPhotosCount > 0 && (
						...
						>
							<Image
								width={500}
								height={500}
								src={urlFor(photos[maximumVisiblePhotos - 1].image).url()}
				...
				{showModal && (
					<div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-90 z-[55]">
						<div className="h-[75vh] w-[320px] lg:w-[700px] relative">
							<Image
								src={urlFor(photos[currenPhotoIndex].image).url()}
								alt={`Room Photo ${currenPhotoIndex + 1}`}
								width={500}
